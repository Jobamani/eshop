...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware(['auth:admin', RedirectIfNotAdmin::class])->group(function () {
        ...
        Route::get('product-edit/{id}/edit', [ProductController::class,'edit'])->name('edit-product');        
        Route::post('product-update{id}', [ProductController::class,'update'])->name('update-product');
        Route::get('product-destroy/{id}/destroy', [ProductController::class,'destroy'])->name('destroy-product');   
